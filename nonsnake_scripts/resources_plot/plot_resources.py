...
def main():
    ...
    ax2.set_ylabel("RAM (GB)", labelpad = 15, rotation=270, y = 0.22)
    ax2.set_ylim(60,-80)
    ax2.set_yticks([0,20,40,60])
    ax2.legend(loc=2, bbox_to_anchor=(0.003, 0.85))
    ...
    plt.subplots_adjust(top=0.95, bottom=0.03, right=0.95, left=0.05)
    DPI = fig.get_dpi()
